...
/// Create a started game with shift tokens enabled and specific tokens for each player.
...
/// Inject specific hands into players (mutates state directly).
...
/// All players Stand for one full turn cycle.
pub fn all_stand(
...
/// Returns the state in Reveal or ImpostorReveal phase.
...
/// Make a hand from two cards (convenience).
